<?php
	...
	{
		$SERVICE_ID = '10770';
		$DB_HOST = $GLOBALS["MOPAAS_MYSQL{$SERVICE_ID}_HOST"];
		$DB_PORT = $GLOBALS["MOPAAS_MYSQL{$SERVICE_ID}_PORT"];
		$DB_USER = $GLOBALS["MOPAAS_MYSQL{$SERVICE_ID}_USER"];
		$DB_PASSWORD = $GLOBALS["MOPAAS_MYSQL{$SERVICE_ID}_PASSWORD"];
		$DB_NAME = $GLOBALS["MOPAAS_MYSQL{$SERVICE_ID}_NAME"];
	}
